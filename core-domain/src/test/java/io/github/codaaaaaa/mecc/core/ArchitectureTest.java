package io.github.codaaaaaa.mecc.core;
...
@AnalyzeClasses(packages = "io.github.codaaaaaa.mecc.core", importOptions = ImportOption.DoNotIncludeTests.class)
class ArchitectureTest {
    ...
    @ArchTest
    static final ArchRule coreDependsOnNoOtherMeccLayer = noClasses()
            .should().dependOnClassesThat()
            .resideInAnyPackage(
